...
const unsigned char PUSH_EDX = 0x52; // modulus 
...
// Encode passes in an unsigned char to be put into mcode at the current location, then increment current
...
unsigned char *  InstructionsClass::Jump()
{
	...
	SetOffset(addressToFillInLater, JUMP_ALWAYS_FAR);			// when we know it!  Call SetOffset() to do that.
	return addressToFillInLater;
}
/////////////////////////////
