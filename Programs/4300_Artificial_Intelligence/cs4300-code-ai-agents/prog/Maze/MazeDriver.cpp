...
int main(int argc, char **argv)
{
  ...
  cgl::Maze::Problem *the_problem = new cgl::Maze::Problem(the_initial_state, the_model);
          ...
          if((*it)->GetState())
            {
              ...
              const cgl::Maze::State * const state = dynamic_cast<const cgl::Maze::State * const>((*it)->GetState());
