...
namespace ai {
  namespace rubiks {
    ...
    void AppConfig::setCubieHeuristic( ) {
      mOptions[ "heuristic" ] = Problem::CUBIE_HEURISTIC;
    }

    void AppConfig::setCornersHeuristic( ) {
      mOptions[ "heuristic" ] = Problem::CORNERS_HEURISTIC;
    }

    void AppConfig::setCornersEdgesHeuristic( ) {
      mOptions[ "heuristic" ] = Problem::CORNERS_EDGES_HEURISTIC;
    }

    void AppConfig::setEdgesHeuristic( ) {
      mOptions[ "heuristic" ] = Problem::EDGES_HEURISTIC;
    }
    ...
    // void AppConfig::setHeuristic( const int heuristic ) {
    //   mOptions[ "heuristic" ] = heuristic;
    // }
