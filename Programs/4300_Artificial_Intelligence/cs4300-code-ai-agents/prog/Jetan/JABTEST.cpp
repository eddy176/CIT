...
JABTEST::JABTEST(ai::Agent::Options *opts)
...
ai::Agent::Action *JABTEST::Program(const ai::Agent::Percept *percept)
{
...
PlyData JABTEST::PickMove(const ai::Jetan::Board &board, int player)
{
...
PlyData JABTEST::Max(const ai::Jetan::Board &board, int player, int depth, double alpha, double beta)
{
...
PlyData JABTEST::Min(const ai::Jetan::Board &board, int player, int depth, double alpha, double beta)
{
    PlyData ply_data(MY_INFINITY);
    //     if (TOTAL_TIME > std::chrono::duration<double>(595))
    // {
...
double JABTEST::Evaluate(const ai::Jetan::Board &board, int player)
{
    double v = 0.0;
...
double JABTEST::EvaluatePieceCountWinPlusWeight2(const ai::Jetan::Board &board, int player)
{
...
double JABTEST::EvaluateAttackedSpaces2(const ai::Jetan::Board &board, int player)
{
    double v = 0;
    const BoardData &boardData = board.GetBoard();
    int i;
...
double JABTEST::EvaluateNewVersion2(const ai::Jetan::Board &board, int player)
{
    double v = 0;
    const BoardData &boardData = board.GetBoard();
    int i;
...
double JABTEST::EvaluatePieceCountWin(const ai::Jetan::Board &board, int player)
{
    const BoardData &boardData = board.GetBoard();
    if (boardData.player_turn == 5)
    {
...
double JABTEST::EvaluatePieceCount(const ai::Jetan::Board &board, int player)
{
    const BoardData &boardData = board.GetBoard();
    double v = 0;
    int i;
