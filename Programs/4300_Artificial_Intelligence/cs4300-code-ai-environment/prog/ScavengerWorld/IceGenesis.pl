...
my $percent_plain  = 0.0;      # percent of plates that are plain like
my $percent_mud    = 0.0;      # percent of plates that are muddy  (The rest are rocky)
my $percent_ice    = 1.0;      # percent of plates that are ice 
...
getopts("?w:h:l:b:n:m:M:p:u:c:o:p:f:F:s:i:", \%Options);
...
-p percent_plain  = 0.0;      # percent of plates that are plain like
-u percent_mud    = 0.0;      # percent of plates that are muddy 
-i percent_ice    = 1.0;      # percent of plates that are icey  (The rest are rocky)
...
if($Options{'i'}) { $percent_ice = $Options{'i'}; }
