    ...
    static struct ai::Agent::Option options[] =
      {
        ...
        {"max-time", 'M', "300.0", "Maximum seconds of think time per agent"},
        {"", 0, "", ""}
      };
      ...
      for(int r = 0; r < runs; r++)
        {
          ...
          env->SetMaxPlayerTime(mOptions.GetArgFlt("max-time"));
          ...
          std::cout << "Agt: " << " " << 1 << " "
                    ...
                    << "Moves: " << std::setw(3)  << final_board.GetPlayerTotalMoves(1) << " "
                    << std::endl;
          ...
          std::cout << "Agt: " << " " << 2 << " "
                    ...
                    << "Moves: " << std::setw(3)  << final_board.GetPlayerTotalMoves(2) << " "
                    << std::endl;

          mRandomNumber = env->GetRandomNumber();
          env->FineSleep(mOptions.GetArgFlt("sleep"));
          delete env;
        }
    }
  }
