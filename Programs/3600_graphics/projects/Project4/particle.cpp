...
//std::vector<Particle*> ParticleSystem::getParticles() { return part };
...
void ParticleSystem::SetDeltaT(double d) {
	mDeltaT = d;
}

void ParticleSystem::SetDrag(double drg) {
	mDrag = drg;
}
...
double ParticleSystem::GetGravity() {
	return mGravity[DIM];
}

void ParticleSystem::SetGravity(double grav) {
	mGravity[DIM] = grav;
}
