...
SpringForce::SpringForce(double red, double green, double blue, Particle* p1_temp, 
	Particle* p2_temp, double spring_constant_temp, double damping_constant_temp, double rest_length_temp):
